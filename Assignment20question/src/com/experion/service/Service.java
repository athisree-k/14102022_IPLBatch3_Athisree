...
public class Service {
	...
	public static void customerPurchase(int customerInput, ArrayList<Product> productList, Date currentDate ) {
		for (Product product : productList) {
		    ...
		    if( product.getExpiryDate().after(currentDate)&&product.getValidityDate().after(currentDate)&&product.getOpenDate().before(currentDate)) {
		    	
		    	System.out.println("Product Active");
		    
		    
		}
		    else if(product.getExpiryDate().equals(currentDate)&&product.getValidityDate().equals(currentDate)&&product.getOpenDate().equals(currentDate)) {
