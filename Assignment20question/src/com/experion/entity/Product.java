...
public class Product {
	...
	public Product(String productCode, String productName,String productDescription,double productPrice,Date openDate,	Date validityDate,Date expiryDate,boolean active ) {
